 ...
 * @author ASUS
 */
public class FormTransaksiMasuk extends javax.swing.JDialog {

    /**
     * Creates new form FormTransaksiMasuk
     *
     * @param parent
     * @param modal
     */
    ...
    public FormTransaksiMasuk(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        centerUI();
    ...
    private void SelectPelanggan() {
        try {
            ...
            java.sql.ResultSet rs = stm.executeQuery("SELECT * FROM indsupplier");
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Transaksi Barang Masuk");
    ...
    private void cmbid_pelangganItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cmbid_pelangganItemStateChanged
        ...
        if (!kode.equals("Pilih")) {
            try {
                Connection conn = koneksi.getConnection();
                java.sql.Statement stm = conn.createStatement();
                java.sql.ResultSet sql = stm.executeQuery("SELECT id FROM indsupplier WHERE kode='" + kode + "'");
                if (sql.next()) {
    ...
    private void btnsaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnsaveActionPerformed
        ...
        if (rowCount > 0 && !"".equals(row_tgl) && !"".equals(row_idpelanggan) && !"".equals(row_idpetugas)) {
            try {
                Connection conn = koneksi.getConnection();
                java.sql.Statement stm = conn.createStatement();
                stm.executeUpdate("INSERT INTO indbarang_masuk(tgl, id_petugas, id_supplier) VALUES ('" + row_tgl + "', '" + row_idpetugas + "', '" + row_idpelanggan + "')");
                koneksi.closeConnection();
            } catch (SQLException e) {
                JOptionPane.showMessageDialog(null, "Error " + e);
            } catch (ClassNotFoundException ex) {
            ...
            try {
                Connection conn = koneksi.getConnection();
                java.sql.Statement stm = conn.createStatement();
                java.sql.ResultSet sql = stm.executeQuery("SELECT MAX(id) as max FROM indbarang_masuk");
                sql.next();
            ...
            for (int i = 0; i < rowCount; i++) {
                ...
                if (not_found == 0) {
                    ...
                    try {
                        Connection conn = koneksi.getConnection();
                        java.sql.Statement stm = conn.createStatement();
                        stm.executeUpdate("INSERT INTO indbarang_masuk_detail(id_barang_masuk, id_barang, jumlah) VALUES ('" + id_barang_masuk + "', '" + id + "', '" + jumlah + "')");
                        empty = 1;
                        koneksi.closeConnection();
                    } catch (SQLException e) {
                        JOptionPane.showMessageDialog(null, "Error " + e);
                ...
                if (empty == 0) {
                    try {
                        Connection conn = koneksi.getConnection();
                        java.sql.Statement stm = conn.createStatement();
                        stm.executeUpdate("DELETE FROM indbarang_masuk WHERE id = '" + id_barang_masuk + "'");
                        koneksi.closeConnection();
                    } catch (SQLException e) {
                        JOptionPane.showMessageDialog(null, "Error " + e);
                    } catch (ClassNotFoundException ex) {
            ...
            try {
                ...
                InputStream file = getClass().getResourceAsStream("/report/report_transaksiMasuk.jrxml");
...
/**
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormTransaksiMasuk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(() -> {
            FormTransaksiMasuk dialog = new FormTransaksiMasuk(new javax.swing.JFrame(), true);
